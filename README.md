...
This package provides a set of high-level functions and classes that make it easy to compute financial ratios. It's patterned after spreadsheet computations and platform-independent, supports iOS and Android.
